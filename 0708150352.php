  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="ttable">
          <!--DWLayoutTable-->
          <form method=post action="0708150352.php?ID=<?php print"$srvsid"; ?>&SID=<?php print"$sid"; ?>&rand=<?php print"$adms"; ?>" >
          <tr> 
            <td width="800" height="202" valign="top"> 
              <?php
			  if ($_POST['op'] != "del") 
				{
			
					$slstm = "select * from srvs_addbook where srvs_id = '$srvsid' and add_id='$compid' and dir_type='$comptype' order by dir_type";
					$rdstm =  mysql_query($slstm)or die(mysql_error());
					...
					if($rdnum<>"0")
							 ...
							 if($comptype=="1")
							 		{
										...
										$rdaddsetup1 = mysql_query($sladdsetup1)or die(mysql_error());
						...
						else
						{
								print "<br><center> Record Sucessfully Deleted From Your Account <br>
										<br> Delete Another One <a href=\"0708150351.php?ID=$srvsid&SID=$sid&rand=$adms\"> Click Here</a></center> ";
					...
					$slstm = "delete from srvs_addbook where srvs_id = '$srvsid' and add_id='$cid' and dir_type='$dty' order by dir_type";
