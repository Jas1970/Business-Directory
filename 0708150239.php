...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tbody>
              ...
              <td width="100%" height="107" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr> 
                    <td width="100%" height="106" valign="top"><table class="aas"   width="100%" border="0" cellpadding="0" cellspacing="0">
                        <!--DWLayoutTable-->
                        <tr> 
                          <td width="493" height="22" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <!--DWLayoutTable-->
                              <tr> 
                                <td width="493" height="22" valign="top" class="bluenote"><a href="index.php" target="_parent">Home</a> 
                          ...
                          <td width="337">&nbsp;</td>
                          <td width="278" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <!--DWLayoutTable-->
                              <tr> 
    ...
    <tr> 
      <td width="205" rowspan="4" valign="top">
    ...
    <tr>
      ...
      <td valign="top">                                                                                           
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="ttable" >
          <!--DWLayoutTable-->
          <tr> 
            <td height="20" align="center" valign="top" class="grncel_LIT title"></td>
          </tr>
          <tr> 
            <td height="14"></td>
          </tr>
            ...
            <td height="66" align="center" valign="top"> 
		      ...
		      if ($op != "del") 
				...
				if ($numrows < 1)
					...
					print "<form method=post action=\"0708150239.php?ID=$rstid&SID=$sid&rand=$adms\">
...
print  "<tr>
			<td colspan=\"2\"><center><input type=submit name= Delete value=Delete></center></td>
	   </tr>";
...
print  "</FORM>";
	...
	$query = "select * from job_tmain where tjob_id=";
	   ...
	   if($rcdcount==0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"0708150239.php?ID=$rstid&SID=$sid&rand=$adms\"> Click Here </a></td></tr>
			</table>";
			exit;
			}	
	   
		   $srvsid = mysql_result($result,0,'tjob_id');
	   
		 	$delrcd = "delete from job_tmain where tjob_id= '$srvsid'";
			   
					if($delnum = mysql_query($delrcd))
					{
					print "Record Sucessfully Delete Delete Another one <br> <a href=\"0708150239.php?ID=$rstid&SID=$sid&rand=$adms\">Click here </a>";
					exit;
					}
					else
					{
