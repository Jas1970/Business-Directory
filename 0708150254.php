  ...
  <tbody>
              ...
              <td width="100%" height="107" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr> 
                    <td width="100%" height="106" valign="top"><table class="aas" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <!--DWLayoutTable-->
                        <tr> 
                          <td width="501" height="22" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <!--DWLayoutTable-->
                              <tr> 
                                <td width="501" height="22" valign="top" class="bluenote"><a href="index.php" target="_parent">Home</a> 
    ...
    <tr>
      ...
      <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="ttable">
          <!--DWLayoutTable-->
            <form method=post action="0708150254.php?ID=<?php print "$rstid"; ?>&SID=<?php print "$sid"; ?>&rand=<?php print "$adms";?>" >
		 <tr> 
			...
			if ($_POST['op'] != "del") 
				{
					$slstm = "select * from dir_addbook where dir_id = '$rstid' and add_id='$compid' and dir_type='$comptype' order by dir_type";
					...
					if($rdnum<>"0")
										...
										if($setupnum<>"")
											{
													...
													if ($pcpname=="1")
														{
														print "<tr><td  class=\"grncel_DRK\">&nbsp;</td><td class=\"grncel_DRK\">$cpname</td></tr>";
														}
													if ($pcname=="1")
														{
						...
						print "<input type=hidden name=DTY value=$comptype>";
						print "<input type=hidden name=ID value=$rstid>";	
						print "<input type=hidden name=CID value=$compid>";				
						print "<input type=hidden name=op value=del>";
						print "<center><input type=submit name= Delete value=  Delete  ></center>";
						}
						else
						{
						print "Record Not Found in Address and Setup Table";
						}
					...
					else
					{
						...
						$slstm = "delete from dir_addbook where dir_id = '$rstid' and add_id='$cid' and dir_type='$dty' order by dir_type";
						if($rdstm =  mysql_query($slstm))
							{
								print "<br><center> Record Sucessfully Deleted From Your Account <br>
										<br> Delete Another One <a href=\"0708150253.php?ID=$rstid&SID=$sid&rand=$adms\"> Click Here</a></center> ";
							}
							else
							{
								print "some problem";
