...
if($prodid<>"")
	{
	$slprdt = "select * from dir_compprod where mdirid= '$rstid' and prod_id='$prodid'";
	...
	if($pcount<>"")
		...
		{
		$insprd = "insert into dir_compprod(mdirid, cat_id,prod_um, prod_rt, asd, prd_desc, prod_id)
				values
				('$rstid','$catid','$punit','$pprice',now(),'$pdesc','$prodid')";
	
	$rdprd = mysql_query($insprd) or die(mysql_error());
	$msg = "Record Successfuly Inserted";
	}
	$slprodt = "select * from dir_compprod where mdirid= '$rstid'";
	$rdprodt = mysql_query($slprodt)or die(mysql_error());
	$rcdcount = mysql_num_rows($rdprodt);
	}
}	

$sl4 = "select * from dir_compprod where mdirid = '$rstid'";
$rd4 = mysql_query($sl4);
$chknum1 	= mysql_num_rows($rd4);

$blimits = abs($limits-$chknum1);
	
$prodid = "";	

$slcat = "select * from catg where catid='$catid'";
$rdcat = mysql_query($slcat)or die(mysql_error());
$catid = mysql_result($rdcat,0,'catid');
...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tbody>
                  ...
                  <tr> 
                    <td width="100%" height="106" valign="top"><table class="aas" width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr> 
                          ...
                          <td width="396">&nbsp;</td>
                          <td width="279" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <!--DWLayoutTable-->
                              <tr> 
    ...
    <tr> 
      ...
      <td width="800px" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="ttable" >
          <!--DWLayoutTable-->
          <tr> 
          ...
          <tr> 
            ...
            <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                <!--DWLayoutTable-->
                <form name="insprod" action="0708150219.php?ID=<?php print"$rstid";?>&SID=<?php print"$sid";?>&rand=<?php print"$adms";?>" method="post" onSubmit="return check(this)">
                  <tr> 
                  ...
                  <tr> 
                    <td  height="22" valign="top" class="org_border_l_cell"><div align="right">Category 
                        Name</div></td>
                    <td  valign="top" class="org_border_no_cell"><div align="center"><strong><font size="4">:</font></strong></div></td>
                    <td  valign="top" class="org_border_r_cell"><strong> <?php print "$catname"; ?>              <!--DWLayoutEmptyCell-->
                      &nbsp; </strong></td>
                  </tr>
                  <tr> 
                    <td height="22" valign="top" class="org_border_l_cell"><div align="right">Product 
                        Name</div></td>
                    <td valign="top" class="org_border_no_cell"><div align="center"><strong><font size="4">:</font></strong></div></td>
                    <td valign="top" class="org_border_r_cell"><label>
				    ...
				    $prodclass = $addProdData[$index];
                                    $proid = $prodclass->getProdid();
                                    $prodnam = $prodclass->getProdnam(); 
                                    print "<option value=\"$proid\">";
                  ...
                  <tr> 
                    <td height="22" valign="top" class="org_border_l_cell"><div align="right">Product 
                        Unit </div></td>
                    <td valign="top" class="org_border_no_cell"><div align="center"><strong><font size="4">:</font></strong></div></td>
                    <td valign="top" class="org_border_r_cell"><input name="punit" type="text" id="punit" size="15" maxlength="10"></td>
                  </tr>
                  <tr> 
                    <td height="22" valign="top" class="org_border_l_cell"><div align="right">Product 
                        Price </div></td>
                    <td valign="top" class="org_border_no_cell"><div align="center"><strong><font size="4">:</font></strong></div></td>
                    <td valign="top" class="org_border_r_cell"> <div align="left"> 
                        <input name="pprice" type="text" id="pprice" value="0.00" size="20" maxlength="15">
                      </div></td>
                  </tr>
                  <tr> 
                    <td height="38" valign="top" class="org_border_l_cell"><div align="right">Product 
                        Description </div></td>
                    <td valign="top" class="org_border_no_cell"><div align="center"><strong><font size="4">:</font></strong></div></td>
          ...
          <tr> 
            ...
            <td valign="top"> <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr> 
                  ...
                  <td valign="top"class="grncel_DRK title"><div align="left"><b> 
                      <?php print "$blimits"; ?></b> &nbsp;</div></td>
                  <td></td>
                </tr>
                <tr> 
                  <td height="23"></td>
