					...
					print "<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">";
						...
						if($setupnum<>"")
							...
							print "</table>";
												...
												{
												print "<center><a href=\"0708150251.php?ID=$rstid&SID=$sid&rand=$adms\">Please Define Display Setup</a></center>";
												}		
						...
						print "<br> <center>Go Address and Setup  <br>
									<br><a href=\"0708150251.php?ID=$rstid&SID=$sid&rand=$adms\"> Click Here</a></center><br>";
