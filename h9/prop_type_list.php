...
$select_rcd = "select type_name from prop_type order by type_name";
$result_rcd = mysql_query($select_rcd,$abc);
$count_rcd = mysql_num_rows($result_rcd);
$display_block = "<table width=\"430px\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" >";
$display_block .= "<tr><td class=\"org_border_box\" width=\"430px\" colspan=\"2\"><center><font color=\"#990000\"><strong> Property Type List</strong> </font></center></td></tr>";
$rownum = abs(1) ;
while ($posts_info = mysql_fetch_array($result_rcd))
		 {
			$typename = $posts_info['type_name'];
