...
$dirid = "$_POST[cno]";
	...
	$slcompm = "select * from prop_main where prop_comp_id='$dirid' and prop_comp_type='2'";
...
if ($_POST[op] != "del") 
	...
	$display_block .= "<table>";
		...
		$slcomp = "select * from srvs_main where sr_id='$dir_id'";
		$rdcomp = mysql_query($slcomp,$abc);
		$cname = mysql_result($rdcomp,0,'cname');
		$dir_city = mysql_result($rdcomp,0,'city');
		$dir_state = mysql_result($rdcomp,0,'stat');
		$dir_add1	= mysql_result($rdcomp,0,'add1');
		$dir_add2	= mysql_result($rdcomp,0,'add2');
		...
		$sladvt = "select * from prop_main where prop_comp_id='$dir_id' and prop_comp_type='2'";
