...
//=================================================================================================================================
		...
		$DirMainIns = "insert into dir_main(dir_cname,dir_cpname,dir_tag,dir_tid, dir_cno)
						values ('$DirCname','$DirCPname','A','$tdirid', '$compid')";
...
//==================================================================================================================				
				...
				$ins_login = "insert into dir_admin(dlogin_cno, dlogin_id, dlogin_pwd)
							  values ( '$dirmid','$compid','$pass')";
...
///==============================================================================================================
///                             Insert into news letter tables
///==============================================================================================================				
		$insnlet = "insert into dir_nletter(dir_id,cat_id, subscribe,dir_cno)
					values
					('$dirmid','$DirCatid','Y','$compid')";
					
		$rdnlet	= mysql_query($insnlet, $abc);
