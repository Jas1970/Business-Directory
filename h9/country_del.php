...
$slcomp = "select * from country order by cntname";
...
if ($numrows < 1)
	...
	print "<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"country.php\"> Click Here </a></td></tr>";
	print "</table>";
	exit;
...
$display_block .= "</FORM>";
	...
	{
//	
	$result=mysql_query("SELECT cntid FROM country ORDER BY cntid") or die("Query failed");
	
	$query = "select * from country where cntid=";
		$flag=TRUE;
	   ...
	   if($rcdcount==0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"country_del.php\"> Click Here </a></td></tr>
			</table>";
			exit;
			}	
	   
	   $srvsid = mysql_result($result,0,'cntid');
	   
	   $chksl = "select * from dir_add where dir_cont='$srvsid'";
	   ...
	   if($chknum<>0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"country_del.php\"> Delete Another One</a></td></tr>
			</table>";
			}
			else
	   		{
				$delrcd = "delete from country where cntid= '$srvsid'";
				if($delnum = mysql_query($delrcd,$abc))
					...
					<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"country_del.php\"> Try Again Please</a></td></tr>
					</table>";
