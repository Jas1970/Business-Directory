...
$slcomp = "select * from district order by dstname";
...
if ($numrows < 1)
	...
	print "<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"district.php\"> Click Here </a></td></tr>";
	print "</table>";
	exit;
...
$display_block .= "</FORM>";
	...
	{
//	
	$result=mysql_query("SELECT dstid FROM district ORDER BY dstid") or die("Query failed");
	
	$query = "select * from district where dstid=";
		$flag=TRUE;
	   ...
	   if($rcdcount==0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"district_del.php\"> Click Here </a></td></tr>
			</table>";
			exit;
			}	
	   
	   $srvsid = mysql_result($result,0,'dstid');
	   
	   $chksl = "select * from dir_add where dir_dist='$srvsid'";
	   ...
	   if($chknum<>0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"district_del.php\"> Delete Another One</a></td></tr>
			</table>";
			}
			else
	   		{
				$delrcd = "delete from district where dstid= '$srvsid'";
				if($delnum = mysql_query($delrcd,$abc))
					...
					<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"district_del.php\"> Try Again Please</a></td></tr>
					</table>";
