...
if ($numrows < 1)
	...
	print "<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"job_type.php\"> Click Here </a></td></tr>";
	print "</table>";
	exit;
	...
	$display_block .= "<tr>
							<td align=\"center\" class=\"org_border_box\" width=\"430px\" colspan=\"2\">Delete From Job Type</td>
					  </tr>";
	$rownum = abs(1);

	while ($pinfo = mysql_fetch_array($rcdcomp))
	 	{
   		$srvsid	= $pinfo['jtype_id'];
		$srvsname = $pinfo['jtype_name'];		
		$display_block .= " 
			<tr>
...
$display_block .= "</FORM>";
	...
	{
//	
	$result=mysql_query("SELECT jtype_id FROM job_type ORDER BY jtype_id") or die("Query failed");
	
	$query = "select * from job_type where jtype_id=";
		$flag=TRUE;
	   ...
	   if($rcdcount==0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"job_type_del.php\"> Click Here </a></td></tr>
			</table>";
			exit;
			}	
	   
	   $srvsid = mysql_result($result,0,'jtype_id');
	   
	   $chksl = "select * from job_main where job_type='$srvsid'";
	   ...
	   if($chknum<>0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"job_type_del.php\"> Delete Another One</a></td></tr>
			</table>";
			}
			else
	   		{
				$delrcd = "delete from job_type where jtype_id= '$srvsid'";
				if($delnum = mysql_query($delrcd,$abc))
					...
					<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"job_type_del.php\"> Try Again Please</a></td></tr>
					</table>";
