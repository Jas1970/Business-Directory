...
if ($numrows < 1)
	...
	print "<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"cat.php\"> Click Here </a></td></tr>";
	print "</table>";
	exit;
	...
	$display_block .= "<tr>
							<td align=\"center\" class=\"org_border_box\" width=\"730px\" colspan=\"2\">Delete From Category Table</td>
					  </tr>";
	$rownum = abs(1);
	...
	while ($pinfo = mysql_fetch_array($rcdcomp))
	 	{
   		$srvsid	= $pinfo['catid'];
		$srvsname = $pinfo['catname'];		
		$display_block .= " 
			<tr>
    		   	<td width=\"650px\" class=\"org_border_l_cell\" ><font color=\"#OOOO0O\"><strong>$rownum.</font> <font color=\"#990033\">$srvsname</strong></font> </td>
...
$display_block .= "</FORM>";
	...
	{
//	
	$result=mysql_query("SELECT catid FROM catg ORDER BY catid") or die("Query failed");
	
	$query = "select * from catg where catid=";
		$flag=TRUE;
	   ...
	   if($rcdcount==0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"cat_del.php\"> Click Here </a></td></tr>
			</table>";
			exit;
			}	
	   
	   $srvsid = mysql_result($result,0,'catid');
	   
	   $chksl = "select * from dir_catprd where cat_id='$srvsid'";
	   ...
	   if($chknum<>0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"cat_del.php\"> Delete Another One</a></td></tr>
			</table>";
			}
			else
	   		{
				$delrcd = "delete from catg where catid= '$srvsid'";
				if($delnum = mysql_query($delrcd,$abc))
					...
					<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"cat_del.php\"> Try Again Please</a></td></tr>
					</table>";
