...
if ($count_rcd == 0)
	...
	print "<table><tr><td width=\"650\" align=\"center\"><h3>There No Any Record For This ID <br>
		<a href= dirAdvtSl6.php> Try Another One </a></h3></td></tr></table>";
...
/*$seldno = "select * from dir_compno where comp_id='$dirid'";
$rdsdno = mysql_query($seldno,$abc);
$dnonumrows = mysql_num_rows($rdsdno);
if($dnonumrows<>0)
	{
		$display_block .="<tr><td Width=\"200\">Department nos. Page Status </td><td>=</td><td>Ok</td><td>Count = $dnonumrows</td></tr>";

	}
	else
	{
		$display_block .="<tr><td>Department nos. page Status 	</td><td>=</td><td>Pending</td><td></td></tr>";
...
$display_block .= "<br>";
$display_block .= "<table>";
$display_block .= "<tr><td width=\"650\"><center><h4><a href=\"dirAdvtSl6.php\">Search Another One </a></h4></center></td></tr>";
