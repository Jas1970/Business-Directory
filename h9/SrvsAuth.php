...
<?php
// Service Authorisation without login
//
...
//========================================================================================================================					
				...
				$ins_login = "insert into srvs_admin(dlogin_cno, dlogin_id, dlogin_pwd)
							  values ( '$srvsid','$compid','$pass')";
...
// ====================================================================================================================
//                News Letter Authorisation table
//=====================================================================================================================				


		$insnlet = "insert into srvs_nletter(sr_id, srvs_id, cno,  subscribe)
					values
					('$srvsid','$srvsids','$compid','Y')";
