...
$asost = "select *  from dir_add, dir_main where dir_add.dir_city = '$cityid' and dir_main.dir_id=dir_add.dir_id and  dir_main.dir_auth='N'   order by dir_cname";
	...
	while ($posts_info = mysql_fetch_array($asorcd))
	 {
       ...
       //add to display
	     $display_block .= " 
		 <tr>
		 	<td width=\"425\">$rownum. <font color=\"#990000\" size=\"3\"> $cname  - $city_name ($state_name)</font></td> <td width=\"150\">(ID : $dirid) </td> 
