...
$slcomp = "select * from prod order by prodnam";
...
if ($numrows < 1)
	...
	print "<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"prod.php\"> Click Here </a></td></tr>";
	print "</table>";
	exit;
...
$display_block .= "</FORM>";
	...
	{
//	
	$result=mysql_query("SELECT prodid FROM prod ORDER BY prodid") or die("Query failed");
	
	$query = "select * from prod where prodid=";
		$flag=TRUE;
	   ...
	   if($rcdcount==0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"prod_del.php\"> Click Here </a></td></tr>
			</table>";
			exit;
			}	
	   ...
	   if($chknum<>0)
			...
			<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"prod_del.php\"> Delete Another One</a></td></tr>
			</table>";
			}
			else
	   		{
				$delrcd = "delete from prod where prodid= '$srvsid'";
				if($delnum = mysql_query($delrcd,$abc))
					...
					<tr><td class=\"org_border_b_cell\" align=\"center\"><a href=\"prod_del.php\"> Try Again Please</a></td></tr>
					</table>";
