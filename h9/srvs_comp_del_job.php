...
$dirid = "$_POST[cno]";
	...
	$slcompm = "select * from job_main where job_comp='$dirid' and job_tag='2'";
...
if ($_POST[op] != "del") 
	...
	$job_comp	= mysql_result($rcdcompm,0,'job_comp');
		...
		$slcomp = "select * from srvs_main where sr_id='$job_comp'";
		...
		$sladvt = "select * from job_main where job_comp='$job_comp' and job_tag='2'";
