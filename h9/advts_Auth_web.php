...
$selcsrvs = "select * from dir_main where dir_id = '$dirid' and dir_auth='N'" ;
...
if($profnum == 0)
	...
	$AdvtS = "update dir_main set dir_auth = 'Y' where dir_id = '$dirid'";	
	$AdvtRd = mysql_query($AdvtS,$abc) or mysql_error();

		 		$AdvtSl2  = "update dir_admin set dlogin_auth = 'Y' where dlogin_cno = '$dirid'";
				$AdvtSl2Rd = mysql_query($AdvtSl2,$abc);	
					
				
			$display_block = "<center><h3> Record Sucessfully Updated With Database  <br>
	 						<a href=\"dirAdvtSl7.php\"> Registered Another One </a> </center><h3>" ;
