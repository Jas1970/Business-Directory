...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tbody>
              ...
              <td width="100%" height="107" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr> 
                    <td width="100%" height="106" valign="top"><table class="aas"   width="100%" border="0" cellpadding="0" cellspacing="0">
                        <!--DWLayoutTable-->
                        <tr> 
                          <td width="603" height="48" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <!--DWLayoutTable-->
                              <tr> 
    ...
    <tr> 
      <td height="1"></tr>
    <tr> 
      <td height="682" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="ttable" >
          <!--DWLayoutTable-->
          <tr> 
          ...
          <tr> 
            ...
            <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="ttable" >
                ...
                <tr> 
                  <td height="463"></td>
                  <td valign="top"> <table id="dashed1"  width="100%" border="2" cellpadding="0" cellspacing="0">
                      <!--DWLayoutTable-->
                         <?php 
                $sl_rcd = "select * from job_main where job_comp ='$srvsid' and job_tag='2'";
				...
				$inds_name = mysql_result($indsrd,0,'inds_name');
					print "
			<tr>
				<td class=\"org_border_nr_box\" colspan=\"3\" width=\"450\"><font class=\"smallp\"><div align=\"left\">$rownum  $jname ($grp_name)</div></font></td>
				<td class=\"org_border_nl_box\" width=\"550\" align=\"right\"><b>Vacancy : $jno</b></td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
				<td class=\"org_border_b_cell bluenote\" colspan=\"4\"><strong>&nbsp;&nbsp;&nbsp; </td>
			</tr>
			<tr>
				<td colspan=\"4\">&nbsp;</td>
			</tr>";
				$rownum++;	
					...
					{
					print "<tr>
							<td colspan=\"4\" align=\"center\">Record Not Exist in Master Job Table</td>
						</tr>";	
					}
					?>
                    </table></td>
