							 ...
							 if($comptype=="1")
							 		{
										...
										print "<tr><td width=\"25\" class=\"grncel_DRK\">&nbsp;</td><td class=\"grncel_DRK\"><b><font size=\"2\"><a href=\"0708150256.php?ID=$rstid&SID=$sid&rand=$adms&cid=$compid&cty=$comptype\">$num. $cname , $citname - ($stname)</a></font></b></td></tr>";
										print "</table>";
										$num++;
									}
									else
									...
									print "<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">";
									print "<tr><td width=\"25\" class=\"grncel_DRK\">&nbsp;</td><td class=\"grncel_DRK\"><font size=\"2\"><b><a href=\"0708150256.php?ID=$rstid&SID=$sid&rand=$adms&cid=$compid&cty=$comptype\">$num. $cname, $citname -($stname)</a></b></font></td></tr>";
									print "</table>";
									$num++;
