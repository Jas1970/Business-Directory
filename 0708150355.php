          ...
          <tr> 
            <td width="100%"> 
              <?php
					...
					print "<center><b><a href=\"0708150357.php?ID=$srvsid&SID=$sid&rand=$adms\">Click Here Printable View </a></b></center>";
            ...
            <tr>
          	...
          	<tr>
            	<td align="center" ><?php  print "<a href=\"0708150350.php?ID=$srvsid&SID=$sid&rand=$adms\"> Go Addressbook Click Here</a>" ?></td>
            </tr>
