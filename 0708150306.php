...
<table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tbody>
              ...
              <td width="100%" height="107" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr> 
                    <td width="100%" height="106" valign="top"><table class="aas"   width="100%" border="0" cellpadding="0" cellspacing="0">
                        <!--DWLayoutTable-->
                        <tr> 
                          <td width="596" height="48" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                              <!--DWLayoutTable-->
                              <tr> 
    ...
    <tr> 
      <td width="194" rowspan="4" valign="top"><table class="tbbgcol" width="194px" border="0" cellpadding="0" cellspacing="0" valign="top" >
          <!--DWLayoutTable-->
          <tr> 
    ...
    <tr> 
      <td height="1"></tr>
    <tr>
      <td height="408" valign="top"><table id="dashed1" width="100%" border="0" cellpadding="0" cellspacing="0" class="ttable" >
          <!--DWLayoutTable-->
          <tr> 
          ...
          <tr>
            ...
            <td align="center" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr> 
                  <td height="21"></td>
                  <td valign="top" class="grncel_DRK title"> <?php print "Mobile No. : $mob"; ?> 
                    &nbsp;</td>
                  <td></td>
                </tr>
                <tr> 
